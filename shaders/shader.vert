...
layout(location = 2) in float inCharIndex;  // Character index for per-character animations

layout(location = 0) out vec2 fragTexCoord;
layout(location = 1) out float fragCharIndex;  // Pass character index to fragment shader
...
void main() {
    ...
    fragCharIndex = inCharIndex;  // Pass through to fragment shader
}
